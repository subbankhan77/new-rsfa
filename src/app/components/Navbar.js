      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            {/* Logos on Right (Responsive block with spacing) */}
            <div className="flex flex-wrap justify-center md:justify-end items-center gap-3">
              ...
              <a
                ...
                className="bg-white rounded-full p-1 shadow-lg border-2 border-blue-200"
              >
                <Image
                  src="/india.png"
        ...
        <nav className="bg-gray-100 border-t">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-between items-center py-3 md:hidden">
              <div className="text-xl font-bold text-gray-700">MENU</div>
              <button
            ...
            {/* Main Navigation */}
            <ul
              className={`flex-col md:flex md:flex-row md:justify-end space-y-2 md:space-y-0 md:space-x-8 py-3 ${mobileMenuOpen ? "flex" : "hidden"
                } md:flex`}
            >
              <li>
                <Link href="/" className="text-gray-600 font-semibold hover:text-blue-800">
                  HOME
                </Link>
              </li>
              <li>
                <Link href="/about" className="bg-white text-gray-600 font-semibold hover:text-blue-800">
                  ABOUT
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-600 font-semibold hover:text-blue-800">
                  CONTACT
                </Link>
              </li>
              <li>
                <Link href="/gallery" className="text-gray-600 font-semibold hover:text-blue-800">
                  GALLERY
                </Link>
              </li>
              ...
              <li className="relative group">
                <button
                  className={`text-gray-600 font-semibold hover:text-blue-800 flex items-center ${pathname.startsWith("/results") ? "text-red-800" : ""
                    }`}
                ...
                <div
                  className={`absolute top-full left-0 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-50 transition-all duration-200 ${dropdownOpen ? "opacity-100 visible" : "opacity-0 invisible"
